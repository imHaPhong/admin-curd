...
import { deleteTechstack } from "../project-type.service";
import { ProjectType } from "./tech-stack-table";

export function TechstackRow({ name, desc, priority, status, _id }: ProjectType) {
